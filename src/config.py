...
# Đường dẫn tới thư mục chứa train.csv, test.csv, validation.csv
...
# Thư mục lưu kết quả trung gian (corpus, index, kết quả benchmark)
...
# Local embedding model; vectors from another model must not reuse the old index.
...
# Số câu hỏi lấy mẫu để benchmark 
SAMPLE_SIZE = 200

# Các giá trị K để đo Precision@K / Recall@K
K_VALUES = [1, 3, 5, 10]
TOP_K_FOR_ANSWER = 3  # số đoạn support đưa vào prompt khi trả lời
