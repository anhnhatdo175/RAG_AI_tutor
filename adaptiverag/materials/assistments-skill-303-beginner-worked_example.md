---
doc_id: "assistments-skill-303-beginner-worked_example"
...
# Volume Cylinder (beginner)

<!-- content_type: worked_example -->
## Learning objective
Build reliable understanding of volume cylinder at the beginner level.

## Level guidance
Use a worked example, name each quantity, and check units after every step.

## Worked example
With radius 3 and height 5, V = pi × 3² × 5 = 45 pi cubic units.
