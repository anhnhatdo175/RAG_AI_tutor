---
doc_id: "assistments-skill-307-advanced-worked_example"
...
target_student_ids: ["78523", "78557", "78561"]
review_status: "needs_subject_matter_review"
---

# Volume Rectangular Prism (advanced)

<!-- content_type: worked_example -->
## Learning objective
Build reliable understanding of volume rectangular prism at the advanced level.

## Level guidance
Handle an unfamiliar representation, justify the formula, and check reasonableness.

## Worked example
A prism with dimensions 4, 3, and 5 has volume 4 × 3 × 5 = 60 cubic units.

## Why the method works
Start from the definition of volume rectangular prism, substitute only known
...
## Practice prompt
Find the volume of a prism measuring 8 by 2 by 3 units.
