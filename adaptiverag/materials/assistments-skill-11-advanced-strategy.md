---
doc_id: "assistments-skill-11-advanced-strategy"
...
3. Select the definition or formula: Use a Venn diagram to represent sets, their intersection, their union, and elements that belong to only one set.
