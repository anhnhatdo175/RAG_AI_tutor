---
doc_id: "assistments-skill-297-intermediate-worked_example"
...
# Area Trapezoid (intermediate)

<!-- content_type: worked_example -->
## Learning objective
Build reliable understanding of area trapezoid at the intermediate level.

## Level guidance
Solve a two-stage variation and compare the result with an estimate.

## Worked example
For bases 8 and 12 and height 5, area = (8 + 12) Ã— 5 / 2 = 50 square units.
