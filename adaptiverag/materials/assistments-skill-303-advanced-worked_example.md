---
doc_id: "assistments-skill-303-advanced-worked_example"
...
# Volume Cylinder (advanced)

<!-- content_type: worked_example -->
## Learning objective
Build reliable understanding of volume cylinder at the advanced level.

## Level guidance
Handle an unfamiliar representation, justify the formula, and check reasonableness.

## Worked example
With radius 3 and height 5, V = pi Ã— 3Â² Ã— 5 = 45 pi cubic units.

## Why the method works
Start from the definition of volume cylinder, substitute only known
...
## Practice prompt
Write the exact volume of a cylinder with radius 2 and height 7.
